...
HARDWARE_TARGETS: list[TargetSeed] = [
    ...
    TargetSeed("pocket-5", "Retroid Pocket 5", "arm64", "uboot",
               ...
               image_url="https://www.goretroid.com/cdn/shop/files/RP5-1.jpg"),
    ...
    TargetSeed("ai-thinker-esp32-cam", "AI-Thinker ESP32-CAM", "xtensa", "custom",
               ...
               image_url="https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/ESP32-CAM.jpg/500px-ESP32-CAM.jpg"),
    TargetSeed("athom-ps01", "Athom PS01 smart plug", "xtensa", "custom",
               soc="ESP32 (Xtensa LX6)",
               notes="EU/US smart plug with energy metering.",
               image_url="https://www.athom.tech/cdn/shop/products/PS01_1.jpg"),
    TargetSeed("laskakit-esplan", "LaskaKit ESPlan", "xtensa", "custom",
               ...
               image_url="https://www.laskakit.cz/user/related_products/esplan-laskakit-esp32-ethernet-deska-pro-iot.jpg"),
    ...
    TargetSeed("weber-igrill-v2", "Weber iGrill v2", "xtensa", "custom",
               ...
               image_url="https://www.weber.com/dw/image/v2/BBJF_PRD/on/demandware.static/-/Sites-weber-master-catalog/default/dw1234abcd/images/iGrill2.jpg"),
