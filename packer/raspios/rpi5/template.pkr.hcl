/*
 * Raspberry Pi OS — Bookworm 64-bit Lite — for Raspberry Pi 5.
 */
...
locals {
  ...
  packed_path   = "${var.cache_root}/raspios/rpi5/raspios-lite-arm64.img.xz"
  manifest_path = "${var.cache_root}/raspios/rpi5/manifest.json"
}
