...
#     SALT_VERSION=3007.14-7 BATOCERA_REPO=https://utils.batocera.gameedu.eu
...
SALT_VERSION="${SALT_VERSION:-3007.14-7}"
...
# prints "misc-salt <ver>-<rel>"; SALT_VERSION is e.g. 3007.14-7). On a fresh
